    ...
    <header className="topbar h-[var(--topbar-h)] bg-surface border-b border-line flex items-center gap-[14px] px-4 sticky top-0 z-20">
      <div className="flex-1 max-w-[480px] mx-auto relative max-[640px]:hidden [&_svg]:absolute [&_svg]:left-2.5 [&_svg]:top-1/2 [&_svg]:-translate-y-1/2 [&_svg]:w-4 [&_svg]:h-4 [&_svg]:text-sub">
        ...
        <input
          ...
          aria-label="Search"
          className="w-full h-[34px] border border-line-strong rounded-md bg-surface-sub pl-[34px] pr-3 text-[13px] text-ink placeholder:text-sub focus:outline-none focus:bg-white focus:border-brand focus:shadow-[0_0_0_3px_rgba(0,128,96,0.14)]"
        />
      </div>
      <div className="flex items-center gap-1.5">
        ...
        >
          <span className="absolute top-[7px] right-2 w-[7px] h-[7px] rounded-full bg-brand border-[1.5px] border-white z-[1]" />
          <BellIcon />
        </button>
        <NavLink
          to="/settings"
